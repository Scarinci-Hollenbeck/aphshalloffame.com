  ...
  return (
    <div className="mx-4 mt-3 text-center">
      <p>
        ...
        history of the high school and its graduates would be remembered and
        celebrated. Carl also saw this as an opportunity to introduce
        outstanding graduates to current high school students, enabling the
        students to observe first hand that success was indeed possible
        regardless of how difficult their backgrounds may be.
      </p>
      <p>
        Mayor Williams enlisted his friend, Judge Ira Kreizman, also an APHS
        graduate, and together they formed a committee to make Carl&apos;s dream
        a reality. The initial committee consisted of Williams and Kreizman,
        Sandy Armstead, the late Gladys Johnson, Henry Johnson, Oliver Jones,
        Janice Davis Keener, Lorraine Hartigan Nonnenberg, and Myrna Wright, the
        ...
        was selected. The initial group was inducted on 4/11/03 before a sold
        out crowd at the Berkeley Carteret Hotel in Asbury Park. Earlier that
        day, many of the inductees met with students at the high school, sharing
      ...
      <p>
        ...
        school where they can be viewed by present day students who will
        hopefully be encouraged to emulate the success of prior students who
        came from similar backgrounds and overcame similar hardships.
      </p>
      <p>
        ...
        charter members, Gladys Johnson, passed away on 1/17/05. The journal was
      ...
      <p>
        ...
        Carteret Hotel. Included in the group of inductees was the late Leon
        Hess, founder of Amerada Hess and owner of the N.Y. Jets, who graduated
        from APHS in 1931.
      </p>
      <p>
      ...
      <p>
        ...
        honorees were inducted into the Hall of Fame during ceremonies held on
        5/21/10, once again, at the Berkeley. The induction ceremony was
        dedicated to the memory of Norma Hess who unfortunately passed away in
        2010.
      </p>
      <p>
